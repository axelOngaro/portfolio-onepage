...
},{}],"js/domElements.js":[function(require,module,exports) {
"use strict";
...
exports.other = other;
var soft = document.querySelector('.soft'); //hidden divs

exports.soft = soft;
var frontendHidden = document.querySelector('.frontend__hidden');
exports.frontendHidden = frontendHidden;
var backendHidden = document.querySelector('.backend__hidden');
exports.backendHidden = backendHidden;
var languagesHidden = document.querySelector('.languages__hidden');
exports.languagesHidden = languagesHidden;
var otherHidden = document.querySelector('.other__hidden');
exports.otherHidden = otherHidden;
var softHidden = document.querySelector('.soft__hidden'); //Learnmore arrow target

exports.softHidden = softHidden;
var backendLearnmore = document.querySelector('#backend__learnmore');
exports.backendLearnmore = backendLearnmore;
var frontendLearnmore = document.querySelector('#frontend__learnmore');
exports.frontendLearnmore = frontendLearnmore;
var otherLearnmore = document.querySelector('#other__learnmore');
exports.otherLearnmore = otherLearnmore;
var softLearnmore = document.querySelector('#soft__learnmore');
exports.softLearnmore = softLearnmore;
var languagesLearnmore = document.querySelector('#languages__learnmore'); //Navigation links and targets
//links

exports.languagesLearnmore = languagesLearnmore;
var homeLink = document.querySelector('#home__link');
exports.homeLink = homeLink;
var skillsLink = document.querySelector('#skills__link');
exports.skillsLink = skillsLink;
var workLink = document.querySelector('#work__link');
exports.workLink = workLink;
var aboutLink = document.querySelector('#about__link');
exports.aboutLink = aboutLink;
var contactLink = document.querySelector('#contact__link'); //Targets
...
exports.form = form;
var formBtn = document.getElementById('form_submit'); //cross

exports.formBtn = formBtn;
var frontendCross = document.getElementById('frontend__learnmore__cross');
exports.frontendCross = frontendCross;
var backendCross = document.getElementById('backend__learnmore__cross');
exports.backendCross = backendCross;
var languagesCross = document.getElementById('languages__learnmore__cross');
...
scrollNav(_domElements.homeLink, _domElements.top);
scrollNav(_domElements.skillsLink, _domElements.skills);
scrollNav(_domElements.workLink, _domElements.work);
scrollNav(_domElements.aboutLink, _domElements.about);
scrollNav(_domElements.contactLink, _domElements.contact);
},{"locomotive-scroll":"../../../node_modules/locomotive-scroll/dist/locomotive-scroll.esm.js","../domElements":"js/domElements.js"}],"js/animations/cssAnimation.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.hiddenAnimationArray = exports.learnMoreAnimationArray = void 0;

var _domElements = require("../domElements");

var skillAnimaton = function skillAnimaton(section, hiddenDiv) {
  section.addEventListener('click', function () {
    hiddenDiv.classList.toggle('visible');
  });
};

var learnMoreAnimation = function learnMoreAnimation(section, learnMore, cross) {
  section.addEventListener('click', function () {
...
var learnMoreAnimationArray = [learnMoreAnimation(_domElements.frontend, _domElements.frontendLearnmore, _domElements.frontendCross), learnMoreAnimation(_domElements.backend, _domElements.backendLearnmore, _domElements.backendCross), learnMoreAnimation(_domElements.languages, _domElements.languagesLearnmore, _domElements.languagesCross), learnMoreAnimation(_domElements.other, _domElements.otherLearnmore, _domElements.otherCross), learnMoreAnimation(_domElements.soft, _domElements.softLearnmore, _domElements.softCross)];
exports.learnMoreAnimationArray = learnMoreAnimationArray;
var hiddenAnimationArray = [skillAnimaton(_domElements.other, _domElements.otherHidden), skillAnimaton(_domElements.soft, _domElements.softHidden), skillAnimaton(_domElements.frontend, _domElements.frontendHidden), skillAnimaton(_domElements.backend, _domElements.backendHidden), skillAnimaton(_domElements.languages, _domElements.languagesHidden)];
exports.hiddenAnimationArray = hiddenAnimationArray;
},{"../domElements":"js/domElements.js"}],"../../../node_modules/gsap/gsap-core.js":[function(require,module,exports) {
"use strict";
...
},{"./gsap-core.js":"../../../node_modules/gsap/gsap-core.js","./CSSPlugin.js":"../../../node_modules/gsap/CSSPlugin.js"}],"js/animations/gsap.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.btnSuccess = void 0;

var _gsap = require("gsap");

var _domElements = require("../domElements");

_gsap.gsap.from('.smooth-scroll', {
  opacity: 0,
  duration: 4,
  ease: 'sine.In'
});
...
var btnSuccess = function btnSuccess() {
  _gsap.gsap.to('#form_submit', {
    backgroundColor: 'green',
    duration: 2
  });

  _domElements.formBtn.innerHTML = '👍';
};
...
var _gsap = require("./animations/gsap");
...
var sendMail = function sendMail() {
  ...
  emailjs.send('pro_gmail', 'contact_form', tempParams).then(function (res) {
...
},{"./animations/gsap":"js/animations/gsap.js"}],"js/main.js":[function(require,module,exports) {
"use strict";

var _loco = require("./animations/loco");

var _cssAnimation = require("./animations/cssAnimation");

var _domElements = require("./domElements");

var _email = require("./email");

require("./animations/gsap");
...
_domElements.form.addEventListener('submit', function (event) {
  event.preventDefault();
  (0, _email.sendMail)();
});

var cross = document.querySelector('#frontend__learnmore__cross');
},{"./animations/loco":"js/animations/loco.js","./animations/cssAnimation":"js/animations/cssAnimation.js","./domElements":"js/domElements.js","./email":"js/email.js","./animations/gsap":"js/animations/gsap.js"}],"../../../../.nvm/versions/node/v15.4.0/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "38837" + '/');
